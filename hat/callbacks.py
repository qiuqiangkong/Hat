...
#                   call_freq=3, metrics=['categorical_error'], transformer=None, dump_path='validation.p', type='epoch', verbose=1):
#         # init values
...
class Validation(Callback):
    ...
    """
    def __init__(self, tr_x=None, tr_y=None, va_x=None, va_y=None, te_x=None, te_y=None, batch_size=100,
                  call_freq=3, metrics=['categorical_error'], generator=None, transformer=None, dump_path='validation.p', type='epoch', verbose=1):
        # init values
        super(Validation, self).__init__(call_freq, type)
        self._batch_size_ = batch_size
        self._metrics_ = to_list(metrics)
